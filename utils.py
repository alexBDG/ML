...
def load_mnist(): #My modified version
    '''
...
#    test_images = pd.read_pickle(directory+'/input/test_images.pkl')
    ...
    x_test = np.array(train_images[35000:40000])
    x_train = normalize_images(x_train)
    x_test = normalize_images(x_test)
    train_labels = pd.read_csv(directory+'/input/train_labels.csv')
    y_train = np.array(train_labels.iloc[:]['Category'])
    y_test = np.array(train_labels[35000:40000].iloc[:]['Category'])
...
#    y_train.shape : (35000, 2, 40000)
#    x_val.shape : (5000, 32, 32, 1)
#    y_val.shape : (5000, 2, 40000)
#    x_test.shape : (5000, 32, 32, 1)
#    y_test.shape : (5000, 2, 40000)
